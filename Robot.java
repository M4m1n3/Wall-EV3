...
public class Robot {
    ...
    public void alignePaletProche() {
        ...
        int rota = (int) (((double) indexMin / (mesures.size() - 1)) * 360);
        // System.out.println(rota);
        act.rotate(rota, false);
        d.msDelay(10000);
    }

    public ArrayList<Double> getMesures() {
        act.chassis.setAngularSpeed(300);
        ArrayList<Double> mesures = new ArrayList<Double>();
        double dN = sens.dist();
        act.rotate(360, true);
    ...
    public int getMin(ArrayList<Double> mesures) {
    ...
    public void alignePaletProche3() {
        ArrayList<Double> mesures = getMesures();
